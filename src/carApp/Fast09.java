...
public class Fast09 implements Features {
	double price; 
	...
	Fast09(double price, String color1, String color2, String color3){
		this.price = price;
		this.color1 = color1;
		this.color2 = color2;
		this.color3 = color3;
	...
	void displayF09() {
		System.out.println("~ Measurements of Fast09:");
