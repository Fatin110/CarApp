...
public class LightningM21 implements Features {
	double price; 
	...
	public LightningM21(double price, String color1, String color2, String color3){
		this.price = price;
		this.color1 = color1;
		this.color2 = color2;
		this.color3 = color3;
		System.out.println("\n1.The LightningM21\n-------------------");
		System.out.println("Available colors: "+color1+", "+color2+", "+color3);
	...
	void displayLM21() {
		System.out.println("~ Measurements of LightningM21:");
		...
		System.out.println("\n~ Digital Features of LightningM21:");
