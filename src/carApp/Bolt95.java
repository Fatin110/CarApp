...
public class Bolt95 implements Features {
	double price; 
	...
	Bolt95(double price, String color1, String color2){
		this.price = price;
		this.color1 = color1;
		this.color2 = color2;
		System.out.println("\n4.The Bolt95\n-------------------");
		System.out.println("Available colors: "+color1+", "+color2);
	...
	void displayB95() {
		System.out.println("~ Measurements of Bolt95:");
